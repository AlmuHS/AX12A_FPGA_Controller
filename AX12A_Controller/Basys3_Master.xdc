...
#SW-4
set_property PACKAGE_PIN W15 [get_ports {angle[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {angle[0]}]
#SW-5
set_property PACKAGE_PIN V15 [get_ports {angle[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {angle[1]}]
#SW-6
set_property PACKAGE_PIN W14 [get_ports {angle[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {angle[2]}]
#SW-7
set_property PACKAGE_PIN W13 [get_ports {angle[3]}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {angle[3]}]
#SW-8
set_property PACKAGE_PIN V2 [get_ports {angle[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {angle[4]}]
#SW-9
set_property PACKAGE_PIN T3 [get_ports {angle[5]}]					
...
#SW-13
set_property PACKAGE_PIN U1 [get_ports {select_com[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {select_com[1]}]
#SW-14
set_property PACKAGE_PIN T1 [get_ports {select_com[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {select_com[2]}]
#SW-15
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {endless_enable}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {endless_enable}]
...
#BTN-L
#set_property PACKAGE_PIN W19 [get_ports receive]						
...
##Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {tx_rx_serial}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tx_rx_serial}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {tx_serial}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {tx_serial}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {enable_write}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {enable_write}]
##Sch name = JA4
...
set_property PACKAGE_PIN A18 [get_ports {tx_serial_pc}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {tx_serial_pc}]
